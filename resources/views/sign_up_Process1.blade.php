                                    ...
                                    <h2 class="info-text">Are You Pre-Approved for a Home Loan? </h2>
                                        ...
                                        <div class="col-sm-10 col-sm-offset-1">
                                          ...
                                          <div class="form-check ">
                                              <input class="form-check-input" type="radio" name="Home_Loan" id="Home_Loan" value="Yes" style=" border: 0px;width: 10%;height: 2em;" onclick="step1()">
                                               <label class="form-check-label" for="inlineRadio1" style="font-size:30px;">Yes</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="radio" name="Home_Loan" id="Home_Loan" value="No" style=" border: 0px;width: 10%;height: 2em;" onclick="step1()">
...
function fill_data() 
{
     ...
     success: function (data) {
             // alert("hello2");
              console.log(data[0].Home_Loan);
           //$('input[name="Home_Loan"]:checked').val(data[0].Home_Loan);
           $('input[name=Home_Loan][value="'+data[0].Home_Loan+'"]').attr('checked', true); 
     }
