                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 col-sm-offset-1">
                                          ...
                                          <div class="form-check ">
                                              <input class="form-check-input" type="radio" name="Covid_19_Disclosure" id="Covid_19_Disclosure" value="Yes" style=" border: 0px;width: 10%;height: 2em;" onclick="step5()">
                                               <label class="form-check-label" for="inlineRadio1" style="font-size:30px;">Yes</label>
                                          </div>
                                          <div class="form-check ">
                                            <input class="form-check-input" type="radio" name="Covid_19_Disclosure" id="Covid_19_Disclosure" value="No" style=" border: 0px;width: 10%;height: 2em;" onclick="step5()">
...
function fill_data() 
{
     ...
     success: function (data) {
           ...
           $('input[name=Covid_19_Disclosure][value="'+data[0].Covid_19_Disclosure+'"]').attr('checked', true); 
     }
...
{
  //alert("test1");
   var data1 =  $('input[name="Covid_19_Disclosure"]:checked').val();
   var _data = {
