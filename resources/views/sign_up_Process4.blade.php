                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 col-sm-offset-1">
                                          ...
                                          <div class="form-check ">
                                              <input class="form-check-input" type="radio" name="Mortgage_Options" id="Mortgage_Options" value="Yes" style=" border: 0px;width: 10%;height: 2em;" onclick="step4()">
                                               <label class="form-check-label" for="inlineRadio1" style="font-size:30px;">Yes</label>
                                          </div>
                                          <div class="form-check ">
                                            <input class="form-check-input" type="radio" name="Mortgage_Options" id="Mortgage_Options" value="No" style=" border: 0px;width: 10%;height: 2em;" onclick="step4()">
...
function fill_data() 
{
     ...
     success: function (data) {
           ...
           $('input[name=Mortgage_Options][value="'+data[0].Mortgage_Options+'"]').attr('checked', true); 
     }
...
function backclick()
{
   $.ajax({
           ...
           success: function (data) {
            // alert("hello2");
             // console.log(data[0].Working_Real_Estate);
          if(data[0].Working_Real_Estate=="No")
          {
            var url = "{{url('/si2')}}";
            $(location).attr('href',url);
          } 
